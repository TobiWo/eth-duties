...
kurtosis run --image-download always --enclave eth-duties-devnet github.com/ethpandaops/ethereum-package@6.0.0 --args-file ./ethereum-devnet-small-replace.yaml &&
