...
class BeaconNode:
    ...
    def get_healthy_beacon_node(
        ...
        beacon_nodes_connection_information: List[NodeConnectionProperties] = (
            ARGUMENTS.beacon_nodes
        )
        for index, node in enumerate(beacon_nodes_connection_information):
