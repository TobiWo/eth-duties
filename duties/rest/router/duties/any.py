...
from rest.core.types import ValidatorDuties
...
async def are_upcoming_duties_in_queue() -> ValidatorDuties:
    ...
    """
    return ValidatorDuties(any=await any_upcoming_duties_in_queue())
